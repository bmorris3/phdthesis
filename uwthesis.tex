...
%
\Title{Photometric and Spectroscopic Perspectives on Stellar Magnetic Activity and Its Effect on Exoplanet Characterization}
...
\chapter*{Update: Ground-based spot occultations of HAT-P-11}
...
\bibliography{./stsp_hat_p_11/bibliography,./sindex/sindex_bibliography,./gaia/gaia_bib,./trappist1_bright/t1bright_bib,./trappist1_rn/t1rn_bib,./hat11rn/bibliography}
