...
%
%\shorttitle{TRAPPIST-1, Kepler-62 and -296 planets with JWST/NIRSpec}
%\shortauthors{Morris et al.}
%
%\begin{document}
%
%\title{The Limits of Transit Characterization with JWST/NIRSpec due to Stellar Variability: The Cases of TRAPPIST-1, Kepler-296 and Kepler-62}
%
...
%\affiliation{Astronomy Department, University of Washington, Seattle, WA 98195, USA}
%\affiliation{NASA Astrobiology Institute's Virtual Planetary Laboratory, University of Washington, Seattle, Washington 98195, USA} % I added the VPL affiliations -- Andrew
%
%\author[0000-0003-0429-9487]{Andrew Lincowski}
%\affiliation{Astronomy Department, University of Washington, Seattle, WA 98195, USA}
%\affiliation{NASA Astrobiology Institute's Virtual Planetary Laboratory, University of Washington, Seattle, Washington 98195, USA}
%
...
%\affiliation{NASA Astrobiology Institute's Virtual Planetary Laboratory, University of Washington, Seattle, Washington 98195, USA}
%
%\author{L. Drake Deming}
%\affiliation{Department of Astronomy, University of Maryland, College Park, MD, USA}
%\affiliation{NASA Astrobiology Institute's Virtual Planetary Laboratory, University of Washington, Seattle, Washington 98195, USA}
%
%
%\author{Suzanne L. Hawley}
%\affiliation{Astronomy Department, University of Washington, Seattle, WA 98195, USA}
%\affiliation{NASA Astrobiology Institute's Virtual Planetary Laboratory, University of Washington, Seattle, Washington 98195, USA} % technically Suzanne was VPL affiliated during the  almost-finished proposal period, though I don't know how often she actually claims it...Andrew
%
%\email{morrisbrettm@gmail.com}
%
%\begin{abstract}
%Stellar variability will likely dominate the observational uncertainties on transit parameters in observations of exoplanets. We construct simulated transit spectrophotometry of the active planet hosts TRAPPIST-1, Kepler-296 and Kepler-62 with JWST/NIRSpec, including  time- and wavelength-dependent rotational modulation by starspots and smaller scale ``microvariability.'' We estimate typical transit time and depth uncertainties, which propagate into uncertainties on atmospheric compositions in transmission spectroscopy, and on bulk composition with mass measurements from transit timing variations. We can distinguish between AAA and BBB atmospheres for TRAPPIST-1 b and c with 10 transits; and we predict mass uncertainties of 10\% for Kepler-62 e and f with N transits. 
%\end{abstract}
%
%\object{TRAPPIST-1, Kepler-62, Kepler-296}
%\keywords{stellar activity, planets: detection, characterization}
%
